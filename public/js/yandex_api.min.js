(function (global){
    ...
    setupAsync({"server":{"url":"//api-maps.yandex.ru/2.1.50","path":"build/release","params":{},"version":1497435651010},"preload":{"load":"package.full"},"key":undefined,"apikey":undefined,"browser":{"name":"Chrome","version":"59.0.3071","base":"Chromium","engine":"WebKit","engineVersion":"537.36","osName":"Windows 7","osFamily":"Windows","osVersion":"6.1","isMobile":false,"cssPrefix":"Webkit"},"lang":"ru_RU","languageCode":"ru","countryCode":"RU","hosts":{"api":{"main":"https://api-maps.yandex.ru/","ua":"https://yandex.ru/legal/maps_termsofuse/?lang={{lang}}","maps":"https://yandex.ru/maps/","statCounter":"https://yandex.ru/clck/","services":{"coverage":"https://api-maps.yandex.ru/services/coverage/","geocode":"https://geocode-maps.yandex.ru/","geoxml":"https://api-maps.yandex.ru/services/geoxml/","inception":"https://api-maps.yandex.ru/services/inception/","panoramaLocate":"https://api-maps.yandex.ru/services/panoramas/","search":"https://api-maps.yandex.ru/services/search/","suggest":"https://suggest-maps.yandex.ru/","regions":"https://api-maps.yandex.ru/services/regions/","route":"https://api-maps.yandex.ru/services/route/"}},"layers":{"map":"https://vec0%d.maps.yandex.net/tiles?l=map&%c&%l","sat":"https://sat0%d.maps.yandex.net/tiles?l=sat&%c&%l","skl":"https://vec0%d.maps.yandex.net/tiles?l=skl&%c&%l","stv":"https://0%d.srdr.maps.yandex.net/?l=stv&%c&v=%v&%l&action=render","sta":"https://lrs.maps.yandex.net/tiles?l=sta&%c&tm=%v&%l","staHotspot":"https://lrs.maps.yandex.net/tiles?l=stj&%c&tm=%v&%l","staHotspotKey":"%c&l=stj&tm=%v"},"traffic":"https://jgo.maps.yandex.net/","trafficArchive":"https://jft.maps.yandex.net/"},"layers":{"map":{"version":"17.06.07-0","scaled":true,"hotspotZoomRange":[13,23]},"sat":{"version":"3.322.0"},"skl":{"version":"17.06.07-0","scaled":true,"hotspotZoomRange":[13,23]},"trf":{"version":"1497512176","scaled":true},"sta":{"version":"0.27.4-0.1.3.0-0.2017.06.01.17.00.2.27.5-1.stable"},"stv":{"version":"3.61.0"}},"geolocation":{"longitude":23.71202,"latitude":52.08951,"isHighAccuracy":false,"span":{"longitude":0.28835,"latitude":0.129488}},"token":"fa4472c938dd73507752b727832b1cdf","sign":(function(r){function t(e){if(n[e])return n[e].exports;var o=n[e]={exports:{},id:e,loaded:!1};return r[e].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var n={};return t.m=r,t.c=n,t.p="",t(0)})([function(r,t,n){"use strict";function e(){for(var r=["f","9","3","1","0","b","1","b","f","d","8","1","b","1","f","d","3","b","c","b","2","7","1","e","4","f","0","e","7","c","5","5","5","7","7","9","a","5","8","c"],t=[[(function(){try{var e=document,t=e.createRange(),a=e.createRange(),n=e.createElement("a");t.setStart(n,0),t.setEnd(n,0),t.compareBoundaryPoints(Range.START_TO_START,a)}catch(r){return r.code}})()+16,SVGUnitTypes.SVG_UNIT_TYPE_OBJECTBOUNDINGBOX-2],[(function(){var e=document.createElement("p");return e.innerHTML="<i ude/>",e.children[0].attributes[0].nodeType})()+6,(function(){try{var e=document.createElement("a");e.appendChild(e)}catch(t){return t.code}})()+3],[SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMAXYMIN,DOMException.SYNTAX_ERR+5]],n=0;n<t.length;n++){var e=t[n][0],o=t[n][1],i=r[e];r[e]=r[o],r[o]=i}return r.join("")}var o,i=n(1),u=n(2);r.exports=function(r){return o||(o=i(e())),i(u(r),o)}},function(r,t){"use strict";r.exports=function(r,t){t=t||0;for(var n=0;n<r.length;n++)t+=(t<<1)+(t<<4)+(t<<7)+(t<<8)+(t<<24),t^=r.charCodeAt(n);return t>>>0}},function(r,t){"use strict";r.exports=function(r){r=r.replace(/^.*\/\//,"");var t=r.indexOf("?");if(-1===t)return r;var n=t+1,e=r.indexOf("#",n);-1===e&&(e=r.length);var o=r.substring(n,e).split("&",1e3);return r.substring(0,n)+o.sort().join("&")+r.substring(e)}}]),"distribution":{},"version":"2.1.50","majorVersion":"2.1","cssPrefix":"ymaps-2-1-50-","coordinatesOrder":"latlong"})
})(this);