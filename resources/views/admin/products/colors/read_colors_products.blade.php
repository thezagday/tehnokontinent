                ...
                <div class="demo-form-wrapper">
                    <form action="" method="" class="form form-horizontal">
                                        ...
                                        <a class="list-group-item">
                                            <div class="media">
                                                <div class="media-middle media-body">
                                                    <h5 class="media-heading">{{$color->title}}</h5>
                                                </div>
                                            </div>
                                        </a>
                                         <a class="list-group-item" href="delete_item_colors_products?id={{$color->id}}&parent={{$parent}}">
                                            <div class="media">
                                                <div class="media-middle media-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="form-control-1"></label>
                            <div class="col-sm-9">
                                <input type="button" class="btn-primary" id="input_btn" value="Добавить" onClick='location.href="add_item_colors_products?parent={{$parent}}"'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="form-control-1"></label>
