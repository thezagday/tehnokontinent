        ...
        <div class="row">
            <div class="col-md-8">
                <div class="demo-form-wrapper">
                    <form action="add_instructions_products" method="post" class="form form-horizontal" enctype="multipart/form-data">
    <p>
        {{ csrf_field() }} 
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="drive-uploader-input" type="file" name="link">
            </div>
         </div>
    </p>
     <div class="form-group">
