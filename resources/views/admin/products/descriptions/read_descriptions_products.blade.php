                ...
                <div class="demo-form-wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="list-group">
                                        <a class="list-group-item" href="edit_item_descriptions_products?id={{$description->id}}">
                                            <div class="media">
                                                <div class="media-middle media-body">
                                                    <h5 class="media-heading">{{$description->title}}</h5>
                                                </div>
                                         ...
                                         <a class="list-group-item" href="delete_item_descriptions_products?id={{$description->id}}&parent={{$description->parent}}">
                                            <div class="media">
                                                <div class="media-middle media-body">
                    ...
                    @endforeach
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="form-control-1"></label>
                            <div class="col-sm-9">
                                <input type="button" class="btn-primary" id="input_btn" value="Добавить" onClick='location.href="add_item_descriptions_products?parent={{$parent}}"'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="form-control-1"></label>
