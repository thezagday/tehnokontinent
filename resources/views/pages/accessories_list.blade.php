    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <form action="accessories_list" method="get" id="count_form">
                ...
                <form action="accessories_list" method="get" id="filter_form">
                ...
                <div class="col-md-9 catalog-list">
                    <div class="row">
                        ...
                        <div class="col-md-12 product-block">
                            <div>
                                <div class="image-block" style="background-image: url({{$item->img_path}});">
                                    <a href="accessories_page?id={{$item->id}}">В РАЗДЕЛ<span class="fa fa-long-arrow-right"></span></a>
                                </div>
                                <div class="info-block">
                                    <h4>{!!$item->title!!}</h4>
